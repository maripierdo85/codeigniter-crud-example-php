...
class Product_model extends CI_Model {
    ...
    public function getProductsByOrderId($id){
        ...
        $this->db->join('client', 'order.client_id = client.id');
        $this->db->select("product.nome, product.sku, product.preco, product_order.product_qtd,order.client_id,CONCAT(client.apellido,', ', client.nombre) AS 'apellidoNombre'");
